...
```bash
pnpm exec vitest run --sequence.shuffle --sequence.seed=20260716
```
...
- 真实金属卡池与实验反击金属选项延期。
- 方程式、沉淀、完整金属反应、响应 DIY、硫酸盐副产和完整反应事件系统延期。

规则边界见 [`docs/MVP0_RULE_FREEZE.md`](docs/MVP0_RULE_FREEZE.md)、[`docs/PHASE8_CHARACTER_RULE_FREEZE.md`](docs/PHASE8_CHARACTER_RULE_FREEZE.md) 和 [`docs/PHASE9_DEBUG_UI_RULE_FREEZE.md`](docs/PHASE9_DEBUG_UI_RULE_FREEZE.md)。开发阶段状态见 [`docs/MVP_PLAN.md`](docs/MVP_PLAN.md)。
